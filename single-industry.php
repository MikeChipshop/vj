            ...
            <div class="vjt_main-content">
                ...
                <div class="vjt_industry-services">
                    <div class="vjt_industry-services-content">
                        <h2>current vjt nuclear services include:</h2>
                        <ul>
                            <li>Real-time Radioscopy (RTR) energies up to 450kV</li>
                            <li>High-Energy RTR with energy up to 9meV</li>
                            <li>High-Resolution Digital Radiography</li>
                            <li>High-Resolution Gamma Assay (TGS/HRGS)</li>
                            <li>Neutron Assay</li>
                            <li>Automated Surface Contamination</li>
                            <li>Dose Rate Monitoring</li>
                            <li>Automated Materials Hardness Testing</li>
                            <li>Visual Inspection via CCTV</li>
                            <li>Automated Waste Package Handling</li>
                            <li>200 Litre Drums – Large Box</li>
                            <li>Waste Package Tracking & Data Management</li>
                        </ul>
                    </div>
                    <div class="vjt_industry-services-img">
                        <img src="https://vjt.crucibledigital.co.uk/wp-content/themes/vjt/img/industry-service-placeholder.png">
                    </div>
                </div>
                <div class="vjt_industry-information">
                    <h2>Further information</h2>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> c-arm</h3>
                    ...
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> conveyor</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> robotic inline</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> software</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> custom systems</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> 3-d ct</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> 2-d</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> Real time</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> high energy</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    ...
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> micro focus</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> in-house inspection</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> field inspection</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> training</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> upgrade</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> maintenance and repairs</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
                    <div class="vjt_industry-information-item">
                        <h3><span><i class="fas fa-chevron-down"></i></span> parts</h3>
                        <div class="vjt_industry-information-content">
                            Content
                        </div>
                    </div>
